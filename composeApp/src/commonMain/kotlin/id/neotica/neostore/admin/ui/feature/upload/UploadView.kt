...
fun UploadView(
    ...
    val dropTarget = rememberPlatformFileDropTarget(
        ...
        onFilesDropped = { files -> viewModel.addFilesToQueue(files) },
    )
    ...
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        NeoCard(
            ...
            modifier = Modifier
                ...
                .clickable(
                    enabled = uiState.uploadQueue.isEmpty(),
            ...
            Column(
                ...
                if (uiState.uploadQueue.isEmpty()) {
                    Text(
                        text = if (uiState.filePath.isEmpty()) "Drag and drop APK(s) here or click to browse"
                        else "File Selected",
